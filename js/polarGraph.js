...
var PolarGraph = (function () {
    ...
    drawPolarGraph.prototype = {
        ...
        drawGraph: function (graphElIds, properties) {
            ...
            var animationEasyCount = 0;                        
            var graphShapeInterval = setInterval(function () {
                var animationEasyLocationValue = properties.animationMotionFrame / 10;
                var easyAddCount;
                var easyInRange = properties.animationEasyInRange;
                var easyOutRange = properties.animationEasyOutRange;
                var inOutSpeed = properties.animationInOutSpeed * 2;
                var centerSpeed = properties.animationCenterSpeed;
                var easySpeed = properties.animationEasySpeed;
