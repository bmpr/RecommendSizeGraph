...
//            this.clearGraphColorEffect = function () {
//            var stopGraph = this.clearCircleGraph(runGraph.canvasInfo, runGraph.circleGraphLocation, runGraph.graphProperties, canvasId, recommendedSizeData, recommendSizeTalbe, circleGraphProperty, listLengthCompareValue);
//        }

            this.runGraphColorEffect = function () {
                this.drawCircleGraphShadow(runGraph.canvasInfo, runGraph.sizesData, runGraph.rateValue, runGraph.circleGraphLocation, runGraph.graphProperties, runGraph.listCompareValue, runGraph.recommendedSizeLocationValue);
                this.drawCircleGraphColorText(runGraph.canvasInfo, runGraph.sizesData, runGraph.recommendedSizeList, runGraph.recommendedSizeLocationValue, runGraph.graphProperties, runGraph.circleGraphLocation);
        ...
        CircleGraph.prototype = {
              ...
              //**그래프 컬러 효과 지우기
        clearCircleGraph: function (canvasInfo, circleGraphLocation, graphProperties, canvasId, recommendedSizeData, recommendSizeTalbe, circleGraphProperty, listLengthCompareValue) {
            ...
            this.drawCircleGraph(canvasId, recommendedSizeData, recommendSizeTalbe, circleGraphProperty, listLengthCompareValue);
            canvasInfo.textContext.restore();
        },
